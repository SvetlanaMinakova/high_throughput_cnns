"""
This module  builds renset models. It is a part of an the open-source project: https://github.com/qubvel/classification_models
All rights belong to the owner of https://github.com/qubvel/classification_models
"""
...
def residual_conv_block(filters, stage, block, strides=(1, 1), attention=None, cut='pre'):
    ...
    # Arguments
        input_tensor: input_examples tensor
...
def ResNet(model_params, input_shape=None, input_tensor=None, include_top=True,
    ...
    the one specified in your Keras config at `~/.keras/keras.json_converters`.
    Args:
        ...
        input_tensor: optional Keras tensor
            ...
            to use as image input_examples for the model.
        input_shape: optional shape tuple, only to be specified
            if `include_top` is False (otherwise the input_examples shape
    ...
    Raises:
        ValueError: in case of invalid argument for `weights`,
            or invalid input_examples shape.
    """
    ...
    # TODO: replace by pre-loaded weights
    """
    if weights:
