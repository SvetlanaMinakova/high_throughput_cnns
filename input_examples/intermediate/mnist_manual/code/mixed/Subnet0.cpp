...
bool Subnet0::do_setup(int argc, char **argv) {
 ...
 graph << common_params.target
       ...
       << PoolingLayer(PoolingLayerInfo(PoolingType::MAX, 3, PadStrideInfo(3, 3, 0, 0)))
           .set_name("Pooling160")
       << FullyConnectedLayer(
           10U,get_weights_accessor(data_path, " ", weights_layout),
